...
def show_help():
    ...
    print(
        f'{Fore.RED}⚠️ Warning: Commands that modify submodules can potentially overwrite changes.{Style.RESET_ALL}'
    )
...
#         logger.error(f"❌ Organization folder '{org_path}' does not exist.")
#         exit(1)
#
#     logger.info(
#         f"🗑 Removing organization folder '{org}' and its submodules..."
#     )
#
...
#
#     logger.success(f"✅ Organization folder '{org}' removed successfully.")
